                    ...
                    <div className = 'rowheader2'>
                        ...
                        <div className='row'>
                            <div className='col-12'>
                                ...
                                <ReactPlayer className='drups-video' playing={true} width = '100%' height = '70%' controls muted url='https://drive.google.com/uc?export=download&id=1KOfvt9gXfLpIxpHv2qHz8i3S0gF3LpY0'/>
                            </div>
                        </div>
