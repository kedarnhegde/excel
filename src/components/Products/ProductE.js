...
class ProductE extends Component {
    render() {
        return(
            <div className = 'main'>
                    ...
                    <div className = 'rowheader2'>
                        <div className = 'row header'>
                            <div className = 'col-12 col-sm-6 align-self-center justify-content-center'>
                                ...
                                <p>Excel Generators can give you DG sets comes with Leroy Somers / Stanford / Marathon alternators for 415V LT and TDPS / AVK / Leroy Somers in 6.6 / 11 kV HT in single and multiple systems. The operating range offer lies in between 750 kVA to 3000 kVA. We provide a design solution from vertical radiators to horizontal radiators, from indoor to outdoor installations with the proper design of ventilation systems for the efficient performance of DG sets with adequate fuel line design and exhaust line to take care of backpressure for efficient operation.</p>
